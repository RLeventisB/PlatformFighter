...
namespace PlatformFighter.Miscelaneous
{
    ...
    public static class ThrowHelper
    {
        ...
        [DoesNotReturn]
        public static void ThrowInvalidTypeWithPointersNotSupported(Type targetType) => throw new ArgumentException($"Cannot use type '{targetType}'. Only value types without pointers or references are supported.");
        ...
        [DoesNotReturn]
        public static void ThrowArgumentException_DestinationTooShort() => throw new ArgumentException("Destination is too short.", "destination");

        [DoesNotReturn]
        public static void ThrowArgumentException_OverlapAlignmentMismatch() => throw new ArgumentException("Overlapping spans have mismatching alignment.");

        [DoesNotReturn]
        public static void ThrowArgumentException_ArgumentNull_TypedRefType() => throw new ArgumentNullException("value", "Type in TypedReference cannot be null.");

        [DoesNotReturn]
        public static void ThrowArgumentException_CannotExtractScalar(ExceptionArgument argument) => throw GetArgumentException(ExceptionResource.Argument_CannotExtractScalar, argument);

        [DoesNotReturn]
        public static void ThrowArgumentException_TupleIncorrectType(object obj) => throw new ArgumentException($"Argument must be of type {obj}.", "other");

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRange_IndexMustBeLessException() => throw GetArgumentOutOfRangeException(ExceptionArgument.index,
                ExceptionResource.ArgumentOutOfRange_IndexMustBeLess);

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRange_IndexMustBeLessOrEqualException() => throw GetArgumentOutOfRangeException(ExceptionArgument.index,
                ExceptionResource.ArgumentOutOfRange_IndexMustBeLessOrEqual);

        [DoesNotReturn]
        public static void ThrowArgumentException_BadComparer(object comparer) => throw new ArgumentException($"Unable to sort because the IComparer.Compare() method returns inconsistent results. Either a value does not compare equal to itself, or one value repeatedly compared to another value yields different results. IComparer: '{comparer}'");

        [DoesNotReturn]
        public static void ThrowIndexArgumentOutOfRange_NeedNonNegNumException() => throw GetArgumentOutOfRangeException(ExceptionArgument.index,
                ExceptionResource.ArgumentOutOfRange_NeedNonNegNum);

        [DoesNotReturn]
        public static void ThrowValueArgumentOutOfRange_NeedNonNegNumException() => throw GetArgumentOutOfRangeException(ExceptionArgument.value,
                ExceptionResource.ArgumentOutOfRange_NeedNonNegNum);

        [DoesNotReturn]
        public static void ThrowLengthArgumentOutOfRange_ArgumentOutOfRange_NeedNonNegNum() => throw GetArgumentOutOfRangeException(ExceptionArgument.length,
                ExceptionResource.ArgumentOutOfRange_NeedNonNegNum);

        [DoesNotReturn]
        public static void ThrowStartIndexArgumentOutOfRange_ArgumentOutOfRange_IndexMustBeLessOrEqual() => throw GetArgumentOutOfRangeException(ExceptionArgument.startIndex,
                ExceptionResource.ArgumentOutOfRange_IndexMustBeLessOrEqual);

        [DoesNotReturn]
        public static void ThrowStartIndexArgumentOutOfRange_ArgumentOutOfRange_IndexMustBeLess() => throw GetArgumentOutOfRangeException(ExceptionArgument.startIndex,
                ExceptionResource.ArgumentOutOfRange_IndexMustBeLess);

        [DoesNotReturn]
        public static void ThrowCountArgumentOutOfRange_ArgumentOutOfRange_Count() => throw GetArgumentOutOfRangeException(ExceptionArgument.count,
                ExceptionResource.ArgumentOutOfRange_Count);

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRange_Year() => throw GetArgumentOutOfRangeException(ExceptionArgument.year,
                ExceptionResource.ArgumentOutOfRange_Year);

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRange_Month(int month) => throw new ArgumentOutOfRangeException(nameof(month), month, "Month must be between one and twelve");

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRange_DayNumber(int dayNumber) => throw new ArgumentOutOfRangeException(nameof(dayNumber), dayNumber, "Day number must be between 0 and DateOnly.MaxValue.DayNumber.");

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRange_BadYearMonthDay() => throw new ArgumentOutOfRangeException(null, "Year, Month, and Day parameters describe an un-representable DateTime.");

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRange_BadHourMinuteSecond() => throw new ArgumentOutOfRangeException(null, "Hour, Minute, and Second parameters describe an un-representable DateTime.");

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRange_TimeSpanTooLong() => throw new ArgumentOutOfRangeException(null, "TimeSpan overflowed because the duration is too long.");

        [DoesNotReturn]
        public static void ThrowOverflowException() => throw new OverflowException();

        [DoesNotReturn]
        public static void ThrowOverflowException_TimeSpanTooLong() => throw new OverflowException("Overflow_TimeSpanTooLong");

        [DoesNotReturn]
        public static void ThrowArgumentException_Arg_CannotBeNaN() => throw new ArgumentException("TimeSpan does not accept floating point Not-a-Number values.");
        ...
        public static ArgumentException GetAddingDuplicateWithKeyArgumentException(object key) => new ArgumentException($"An item with the same key has already been added. Key: {key}");
        ...
        [DoesNotReturn]
        public static void ThrowArgumentException(ExceptionResource resource) => throw GetArgumentException(resource);

        [DoesNotReturn]
        public static void ThrowArgumentException(ExceptionResource resource, ExceptionArgument argument) => throw GetArgumentException(resource, argument);

        [DoesNotReturn]
        public static void ThrowArgumentException_HandleNotSync(string paramName) => throw new ArgumentException("Handle does not support synchronous operations. The parameters to the FileStream constructor may need to be changed to indicate that the handle was opened asynchronously (that is, it was opened explicitly for overlapped I/O).", paramName);

        [DoesNotReturn]
        public static void ThrowArgumentException_HandleNotAsync(string paramName) => throw new ArgumentException("    <value>Handle does not support asynchronous operations. The parameters to the FileStream constructor may need to be changed to indicate that the handle was opened synchronously (that is, it was not opened for overlapped I/O).", paramName);
        [DoesNotReturn]
        public static void ThrowArgumentNullException(string parameterName) => throw new ArgumentNullException(parameterName);
        [DoesNotReturn]
        public static void ThrowArgumentNullException(ExceptionArgument argument) => throw new ArgumentNullException(GetArgumentName(argument));

        [DoesNotReturn]
        public static void ThrowArgumentNullException(ExceptionResource resource) => throw new ArgumentNullException(GetResourceString(resource));

        [DoesNotReturn]
        public static void ThrowArgumentNullException(ExceptionArgument argument, ExceptionResource resource) => throw new ArgumentNullException(GetArgumentName(argument), GetResourceString(resource));

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException(ExceptionArgument argument) => throw new ArgumentOutOfRangeException(GetArgumentName(argument));

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException(ExceptionArgument argument, ExceptionResource resource) => throw GetArgumentOutOfRangeException(argument, resource);

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException(ExceptionArgument argument, int paramNumber, ExceptionResource resource) => throw GetArgumentOutOfRangeException(argument, paramNumber, resource);

        [DoesNotReturn]
        public static void ThrowEndOfFileException() => throw CreateEndOfFileException();

        public static Exception CreateEndOfFileException() =>
        ...
        [DoesNotReturn]
        public static void ThrowInvalidOperationException(ExceptionResource resource) => throw GetInvalidOperationException(resource);

        [DoesNotReturn]
        public static void ThrowInvalidOperationException(ExceptionResource resource, Exception e) => throw new InvalidOperationException(GetResourceString(resource), e);

        [DoesNotReturn]
        public static void ThrowNullReferenceException() => throw new NullReferenceException("The method was called with a null array argument.");

        [DoesNotReturn]
        public static void ThrowSerializationException(ExceptionResource resource) => throw new SerializationException(GetResourceString(resource));

        [DoesNotReturn]
        public static void ThrowRankException(ExceptionResource resource) => throw new RankException(GetResourceString(resource));

        [DoesNotReturn]
        public static void ThrowNotSupportedException(ExceptionResource resource) => throw new NotSupportedException(GetResourceString(resource));

        [DoesNotReturn]
        public static void ThrowNotSupportedException_UnseekableStream() => throw new NotSupportedException("Stream does not support seeking.");

        [DoesNotReturn]
        public static void ThrowNotSupportedException_UnreadableStream() => throw new NotSupportedException("Stream does not support reading.");

        [DoesNotReturn]
        public static void ThrowNotSupportedException_UnwritableStream() => throw new NotSupportedException("Stream does not support writing.");

        [DoesNotReturn]
        public static void ThrowObjectDisposedException(object instance) => throw new ObjectDisposedException(instance?.GetType().FullName);

        [DoesNotReturn]
        public static void ThrowObjectDisposedException(Type type) => throw new ObjectDisposedException(type?.FullName);

        [DoesNotReturn]
        public static void ThrowObjectDisposedException_StreamClosed(string objectName) => throw new ObjectDisposedException(objectName, "Cannot access a closed Stream.");

        [DoesNotReturn]
        public static void ThrowObjectDisposedException_FileClosed() => throw new ObjectDisposedException(null, "Cannot access a closed file.");

        [DoesNotReturn]
        public static void ThrowObjectDisposedException(ExceptionResource resource) => throw new ObjectDisposedException(null, GetResourceString(resource));
        ...
        [DoesNotReturn]
        public static void ThrowArgumentException_Argument_InvalidArrayType() => throw new ArgumentException("Target array type is not compatible with the type of items in the collection.");

        [DoesNotReturn]
        public static void ThrowArgumentException_InvalidHandle(string paramName) => throw new ArgumentException("Invalid handle.", paramName);

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_InvalidOperation_EnumNotStarted() => throw new InvalidOperationException("Enumeration has not started. Call MoveNext.");

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_InvalidOperation_EnumEnded() => throw new InvalidOperationException("Enumeration already finished.");

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_EnumCurrent(int index) => throw GetInvalidOperationException_EnumCurrent(index);

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_InvalidOperation_EnumFailedVersion() => throw new InvalidOperationException("Collection was modified; enumeration operation may not execute.");

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_InvalidOperation_EnumOpCantHappen() => throw new InvalidOperationException("Enumeration has either not started or has already finished.");

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_InvalidOperation_NoValue() => throw new InvalidOperationException("Nullable object must have a value.");

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_ConcurrentOperationsNotSupported() => throw new InvalidOperationException("Operations that change non-concurrent collections must have exclusive access. A concurrent update was performed on this collection and corrupted its state. The collection's state is no longer correct.");

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_HandleIsNotInitialized() => throw new InvalidOperationException("Handle is not initialized.");

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_HandleIsNotPinned() => throw new InvalidOperationException("Handle is not pinned.");

        [DoesNotReturn]
        public static void ThrowArraySegmentCtorValidationFailedExceptions(Array array, int offset, int count) => throw GetArraySegmentCtorValidationFailedException(array, offset, count);

        [DoesNotReturn]
        public static void ThrowFormatException_BadFormatSpecifier() => throw new FormatException("Format specifier was invalid.");

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException_PrecisionTooLarge() => throw new ArgumentOutOfRangeException("precision", $"Precision cannot be larger than {StandardFormat.MaxPrecision}");

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException_SymbolDoesNotFit() => throw new ArgumentOutOfRangeException("symbol", "Format specifier was invalid.");

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException_NeedNonNegNum(string paramName) => throw new ArgumentOutOfRangeException(paramName, "Non-negative number required.");

        [DoesNotReturn]
        public static void ArgumentOutOfRangeException_Enum_Value() => throw new ArgumentOutOfRangeException("value", "Enum value was out of legal range.");

        [DoesNotReturn]
        public static void ThrowApplicationException(int hr)
        {
        ...
        [DoesNotReturn]
        public static void ThrowFormatInvalidString() => throw new FormatException("Input string was not in a correct format.");

        public static Exception GetArraySegmentCtorValidationFailedException(Array array, int offset, int count)
        {
            if (array == null)
        ...
        public static ArgumentException GetArgumentException(ExceptionResource resource) => new ArgumentException(GetResourceString(resource));

        public static InvalidOperationException GetInvalidOperationException(ExceptionResource resource) => new InvalidOperationException(GetResourceString(resource));

        public static ArgumentException GetWrongKeyTypeArgumentException(object key, Type targetType) => new ArgumentException($"The value \"{key}\" is not of type \"{targetType}\" and cannot be used in this generic collection.", nameof(key));

        public static ArgumentException GetWrongValueTypeArgumentException(object value, Type targetType) => new ArgumentException($"The value \"{value}\" is not of type \"{targetType}\" and cannot be used in this generic collection.", nameof(value));

        public static KeyNotFoundException GetKeyNotFoundException(object key) => new KeyNotFoundException($"The given key '{key}' was not present in the dictionary.");

        public static ArgumentOutOfRangeException GetArgumentOutOfRangeException(ExceptionArgument argument, ExceptionResource resource) => new ArgumentOutOfRangeException(GetArgumentName(argument), GetResourceString(resource));

        public static ArgumentException GetArgumentException(ExceptionResource resource, ExceptionArgument argument) => new ArgumentException(GetResourceString(resource), GetArgumentName(argument));

        public static ArgumentOutOfRangeException GetArgumentOutOfRangeException(ExceptionArgument argument, int paramNumber, ExceptionResource resource) => new ArgumentOutOfRangeException(GetArgumentName(argument) + "[" + paramNumber + "]", GetResourceString(resource));

        public static InvalidOperationException GetInvalidOperationException_EnumCurrent(int index) => new InvalidOperationException(
                index < 0 ? "Enumeration has not started. Call MoveNext." : "Enumeration already finished.");
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ThrowForUnsupportedNumericsVectorBaseType<T>() where T : struct
        {
        ...
        // is supported and we're on an optimized release build.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ThrowForUnsupportedIntrinsicsVector64BaseType<T>() where T : struct
        {
        ...
        // is supported and we're on an optimized release build.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ThrowForUnsupportedIntrinsicsVector128BaseType<T>() where T : struct
        {
        ...
        // is supported and we're on an optimized release build.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ThrowForUnsupportedIntrinsicsVector256BaseType<T>() where T : struct
        {
...
#if false
        // Reflection-based implementation does not work for NativeAOT
        // This function will convert an ExceptionResource enum value to the resource string.
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static string GetResourceString(ExceptionResource resource)
        {
